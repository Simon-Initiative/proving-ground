defmodule DeliveryWeb.InstitutionControllerTest do
  use DeliveryWeb.ConnCase

  alias Delivery.LTI

  @create_attrs %{country_code: "some country_code", id: "some id", institution_email: "some institution_email", institution_url: "some institution_url", name: "some name", timezone: "some timezone"}
  @update_attrs %{country_code: "some updated country_code", id: "some updated id", institution_email: "some updated institution_email", institution_url: "some updated institution_url", name: "some updated name", timezone: "some updated timezone"}
  @invalid_attrs %{country_code: nil, id: nil, institution_email: nil, institution_url: nil, name: nil, timezone: nil}

  def fixture(:institution) do
    {:ok, institution} = LTI.create_institution(@create_attrs)
    institution
  end
