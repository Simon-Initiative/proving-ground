...
export class Image extends React.Component<ImageProps, ImageState> {
  ...
  constructor(props) {
    ...
    const image = getData<ImageData>(props.node.data);
  ...
  componentDidMount() {
    ...
    if (this.fetchSize) {
      const image = getData<ImageData>(this.props.node.data);
  ...
  render() {
    const { editor, node, isFocused } = this.props;
    const image = getData<ImageData>(this.props.node.data);
